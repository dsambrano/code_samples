...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/deshawnsambrano/Drive/CodeSamples/Python/PsychoPy/Ambiguity/untitled.psyexp',
...
# keep track of which components have finished
instr2Components = [text_3, key_resp_3]
